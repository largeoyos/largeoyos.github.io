# 离散数学 第 21.6 节：进阶数论 —— 二次剩余、Carmichael 函数与佩尔方程

好，我们补充几个**重要但不常出现在标准本科教材里**的数论主题。这些内容是：
...
**选项 A**：进入**第 22 节：综合复习与考试技巧**——把整门课所有内容串起来，给应试策略和模拟题。

**选项 B**：进一步深入特定方向，比如：

- **椭圆曲线**详细数学（深入到 ECDSA、配对密码）
- **格密码学**（后量子密码核心）
- **零知识证明**（数论 + 抽象代数）
- **代数几何入门**（数论的现代化）
